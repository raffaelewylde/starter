...
if g.os == "Linux" or g.os == "Darwin" then
  ...
  g.ruby_host_prog = "$HOME/.local/share/mise/installs/ruby/3.3.3/bin/neovim-ruby-host"
  g.python3_host_prog = "$HOME/.local/share/mise/installs/python/latest/bin/python3"
  --g.node_host_prog = "$HOME/.local/share/mise/installs/node/20.15.1/bin/node"
  g.node_host_prog = "$HOME/.local/share/mise/installs/node/lts/bin/neovim-node-host"
